...
import { X, MessageSquare, ShoppingBag, Award, Check, Sparkles, RefreshCw, Compass, Shield, Target, Scroll, CheckCircle2 } from 'lucide-react';
    ...
    <div id="npc-modal-overlay" className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex items-center justify-center p-3 sm:p-5">
      ...
      >
        ...
        <div className="flex-1 py-4 overflow-y-auto min-h-0 space-y-4">
          {/* DIALOGUE TAB */}
          {activeTab === 'dialogue' && (
            <div className="bg-black/60 rounded-xl border border-gray-800 p-4.5 space-y-3 font-sans text-sm text-gray-300 leading-relaxed">
              ...
              {dynamicLore && (
                <div className="mt-4 p-3 rounded-lg bg-amber-950/20 border border-amber-500/30 text-amber-200/90 text-xs italic">
          ...
          {activeTab === 'shop' && npc.shopItems && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {npc.shopItems.map((item) => {
                const canAfford = playerGold >= item.valueGold;
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-[10px] font-mono text-[#fbbf24]">🪙 {item.valueGold} Gold</div>
                      </div>
                    </div>
